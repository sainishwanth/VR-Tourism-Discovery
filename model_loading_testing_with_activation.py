...
parser.add_argument('--voice', choices=['yes', 'no'], default='no', help='Enable voice activation (yes/no)')
...
# Using 'say' command with Justine's voice
...
if args.voice == 'yes':
    while True:
        with sr.Microphone() as source:
            try:
                ...
                audio_activation = r.listen(source)
                activation_phrase = r.recognize_google(audio_activation).lower()
                print(activation_phrase)
                if "hey discovery" in activation_phrase.lower():
                    print("Activation successful!")
                else:
                    print("Activation phrase not detected. Please try again.")
                    continue
    ...
    print("Voice activation is disabled. Please ask your question:")
    while True:
        with sr.Microphone() as source:
            try:
                print("Please ask your question:")
